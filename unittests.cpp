...
TEST_CASE("Testing multiplication", "interpreter.hpp")
{
	...
	REQUIRE(inter.multiplication(negative.data.number_value,
	 negative.data.number_value) == 4.0);
...
TEST_CASE("Testing division", "interpreter.hpp")
{
	...
	positive.data.type = Expression::NumberType;
	positive.data.number_value = 2;


	REQUIRE(inter.division(bigger.data.number_value,
	 smaller.data.number_value) == 5);

	REQUIRE(inter.division(smaller.data.number_value,
	 bigger.data.number_value) == 0.2);

	REQUIRE(inter.division(positive.data.number_value,
	 negative.data.number_value) == -1);

	REQUIRE(inter.division(negative.data.number_value,
	 negative.data.number_value) == 1);

	REQUIRE(inter.division(negative.data.number_value,
	 positive.data.number_value) == -1);
...
TEST_CASE("Testing the Interpreter's equality", "interpreter.hpp")
{
	...
	REQUIRE(inter.equals(left.data.number_value,
	 one_more.data.number_value) == true);
...
TEST_CASE("Tesing NumberType methods and constructors", "expression.hpp")
{
	...
	express_two.data.number_value = 1050.0;
	express_two.data.type = Expression::NumberType;
